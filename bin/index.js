...
program.name("qc-cli").usage(`<command> [option]`);
program.version(`qc-cli ${require("../package.json").version}`);
program
  .command("create <project-name>") // 增加创建指令
  .description("use qc-cli create ** to create a new program") // 添加描述信息
  .option(
    "-f, --force",
